...
describe('buildReviewPlayerHeader', () => {
  it('projects session and daily-goal progress independently', () => {
    ...
    expect(view).toMatchObject({ currentPosition: 3, totalCards: 20, remainingCards: 17, progressValue: 0.15, progressPercent: 15 });
  ...
  it('clamps invalid and over-complete values for presentation', () => {
    ...
    expect(view).toMatchObject({ currentPosition: 3, remainingCards: 0, progressValue: 1, progressPercent: 100 });
